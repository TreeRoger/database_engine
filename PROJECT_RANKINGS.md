...
- Directly relevant to backend/infrastructure roles
- Shows you can build something complex from scratch
...
- Highly relevant to most tech companies
- Easy to benchmark and show performance
...
- Demonstrates Rust's strengths (safety + performance)
...
- Common interview topic (many companies ask about shells)
...
- Demonstrates graphics/math knowledge
...
- Shows you understand how computers really work
...
- Less impressive than full systems
- Better as supplementary projects

### 21-25. Developer Tools
- Good for showing tooling knowledge
- Less impressive than core systems
- Better for specific roles (compiler, tooling)

### 26-28. Embedded/IoT
- Great for embedded roles
...
3. **Testing** - Unit tests, integration tests show professionalism
4. **Performance** - Benchmarks and optimizations are impressive
...
2. **Then Database Engine** (4-6 weeks) - More complex, shows depth
3. **Add features incrementally** - Keep improving and committing

**For depth over breadth:**
- Pick **Database Engine** and make it really impressive
- Add: transactions, concurrency, query language, replication
- Write detailed docs and blog posts about it
